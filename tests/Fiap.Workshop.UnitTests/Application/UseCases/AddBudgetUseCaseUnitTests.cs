...
public class AddBudgetUseCaseUnitTests : LoggerTestBase<AddBudgetUseCase>
{
    ...
    private static InventoryItem CreateInventoryItem(Guid id, int quantityOnHand, decimal unitPrice) => new(
        id,
        "BP-001",
        "Brake Pad",
        "Brake pad set",
    ...
    private static Service CreateService(Guid id, decimal basePrice) => new(
        id,
        "SV-001",
        "Oil Change",
        "Oil change service",
